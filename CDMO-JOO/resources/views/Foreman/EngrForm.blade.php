  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">WorkList</a>
      </li>
     <!--  <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/up_logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style= "filter: drop-shadow(0 0 0.95rem white);"<!-- "opacity: .8" -->
...
<li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                    itc.conise@gmail.com <span class="caret"></span>
                                </a>
                                ...
                                <ul class="dropdown-menu btn btn-secondary btn-sm" role="menu">
                                    <li>
                                        ...
                                        <form id="logout-form" action="http://localhost:8000/logout" method="POST" style="display: none;">
                                            <input type="hidden" name="_token" value="a9VonMDeXPc720bW00liHtwHUCZlTN9TjVBgP7VT">
                                        </form>
                                    </li>
                                </ul>
                            </li>
